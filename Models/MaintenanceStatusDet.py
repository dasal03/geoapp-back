...
class MaintenanceStatusDetModel(Base):
    __tablename__ = "maintenance_status_det"
    maintenance_status_det_id = Column(Integer, primary_key=True)
    maintenance_status_cab_id = Column(Integer, nullable=False)
    ...
    def __init__(self, **kwargs):
        ...
        self.maintenance_status_cab_id = kwargs.get(
