...
class UserModel(Base):
    ...
    country_of_issue_id = Column(Integer, default=0)
    state_of_issue_id = Column(Integer, default=0)
    city_of_issue_id = Column(Integer, default=0)
    ...
    def __init__(self, **kwargs):
        ...
        self.country_of_issue_id = kwargs.get("country_of_issue_id", 0)
